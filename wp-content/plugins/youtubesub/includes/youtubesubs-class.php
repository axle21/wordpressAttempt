...
class Youtube_Subs_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			array( 'Widget to Display Youtube Subs' => esc_html__( 'A Foo Widget', 'yts_domain' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		echo $args['before_widget']; //What evr you want to display before the widget
		...
		echo $args['after_widget'];  //What evr you want to diaplay after the widget
	}
	...
	public function form( $instance ) {
		...
		$channel = ! empty( $instance['channel'] ) ? $instance['channel'] : esc_html__( 'axletv', 'yts_domain' );
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'layout' ) ); ?>"><?php esc_attr_e( 'Layouts:', 'yts_domain' ); ?></label> 
